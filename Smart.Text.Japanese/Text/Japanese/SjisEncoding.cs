namespace Smart.Text.Japanese
{
    ...
    {
        private static readonly Lazy<Encoding> Provider = new(() => Encoding.GetEncoding("Shift_JIS"));

        public static Encoding Instance => Provider.Value;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int GetByteCount(string str) => Instance.GetByteCount(str);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte[] GetBytes(string str) => Instance.GetBytes(str);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetString(byte[] bytes, int index, int count) => Instance.GetString(bytes, index, count);
